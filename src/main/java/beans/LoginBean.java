...
public class LoginBean implements Serializable {
    ...
    private void enviarEmail(Usuario usuario) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress("jorgeluispe@hotmail.com")); //Remetente
            message.setRecipients(Message.RecipientType.TO,
                    InternetAddress.parse(usuario.getEmail())); //Destinatário(s)
            message.setSubject("Recuperacao de senha do sistema APPSEFAZ");//Assunto
            message.setText("Voce solicitou sua senha atraves do sistema APPSEFAZ - "
